...
export const servicePages: ServicePage[] = [
  {
    ...
    summary: "CNC strafor işleme; EPS ve XPS blokların dijital modelden iki veya üç boyutlu fiziksel forma dönüştürülmesidir. Ardıç Design & Fabrication bu hizmeti İstanbul'daki atölyesinde heykel, maket, kalıp, rölyef, sahne dekoru ve büyük ölçekli özel üretimler için sunar.",
  ...
  },
  {
    ...
    title: "Strafor Heykel Üretimi İstanbul",
    metaTitle: "Strafor Heykel Üretimi İstanbul | Büyük Ölçekli Heykel | Ardıç",
    description: "İstanbul'da EPS ve XPS ile özel strafor heykel, karakter, maskot, dev obje ve tematik figür üretimi; kaplama, boya ve montaj seçenekleri.",
    eyebrow: "Heykel Üretimi",
    summary: "Strafor heykel üretimi; EPS veya XPS köpüğün CNC ve el işçiliğiyle karakter, figür, maskot ya da büyük ölçekli objeye dönüştürülmesidir. Ardıç, İstanbul'daki atölyesinde projeye özel formları kullanım yeri ve dayanım beklentisine göre kaplar, boyar ve montaja hazırlar.",
  ...
  },
  {
    ...
    title: "EPS ve XPS CNC İşleme / 3D Strafor Kesim",
    metaTitle: "EPS & XPS CNC İşleme | 3D Strafor Kesim | Ardıç",
    description: "EPS ve XPS köpüklerde CNC kesim ve 3D strafor işleme; heykel, kalıp modeli, rölyef, mimari detay ve özel dekor üretimi.",
    eyebrow: "Köpük İşleme",
    summary: "EPS ve XPS CNC işleme, köpük blokların dijital modele göre kesilmesi ve üç boyutlu biçimlendirilmesidir. EPS hafif ve ekonomik çözümler, XPS ise daha homojen ve yoğun yüzeyler sunabilir; Ardıç malzemeyi detay, kullanım alanı ve sonraki kaplama sürecine göre seçer.",
  ...
  },
  {
    ...
    title: "Tema Park Dekor Üreticisi İstanbul",
    metaTitle: "Tema Park Dekor Üreticisi İstanbul | Heykel ve Dekor | Ardıç",
    description: "İstanbul'da tema park ve eğlence alanları için karakter, heykel, yapay kaya, tematik cephe ve deneyim dekoru üretimi.",
    eyebrow: "Deneyim Alanları",
    summary: "Tema park dekor üretimi; karakter, heykel, yapay kaya, tematik cephe ve ziyaretçi deneyimi elemanlarının sahaya uygun biçimde hazırlanmasıdır. Ardıç, İstanbul'daki atölyesinde bu parçaları ölçek, dayanım, ziyaretçi teması, sevkiyat ve montaj koşullarını birlikte değerlendirerek üretir.",
  ...
  },
  {
    ...
    title: "AVM Dekor Üretimi ve Ticari Mekan Uygulamaları",
    metaTitle: "AVM Dekor Üreticisi İstanbul | Ticari Mekan | Ardıç",
    description: "İstanbul'da AVM, mağaza, restoran ve marka alanları için özel dekor, heykel, vitrin objesi ve mimari uygulama üretimi.",
    eyebrow: "Ticari Mekanlar",
    summary: "AVM dekor üretimi; ortak alan, vitrin, mağaza ve marka etkinlikleri için projeye özel fiziksel elemanların hazırlanmasıdır. Ardıç, büyük ürün replikaları, heykeller, fotoğraf alanları, vitrin objeleri ve mimari dekorları İstanbul'daki atölyesinde üretir.",
  ...
  },
  {
    ...
    title: "Sahne ve Etkinlik Dekoru Üretimi",
    ...
    summary: "Sahne ve etkinlik dekoru üretimi; kısa sürede kurulabilen, güvenli taşınan ve güçlü görsel etki oluşturan fiziksel elemanların hazırlanmasıdır. Ardıç; sahne, fuar, lansman ve marka etkinlikleri için hafif, modüler ve projeye özel dekorlar üretir.",
